...
import nl.juraji.reactive.albums.services.analysis.DuplicateAnalysisService
...
class TEMPAnalyzeDuplicatesSaga {
    /**
    ...
    fun on(evt: ContentHashUpdatedEvent) {
        duplicateAnalysisService.analyzeDuplicates(evt.pictureId).block()
        SagaLifecycle.end()
    }
}
